...
* 
* Ändringar gjorda: 
* Lade till en class för tr-elementet som innehåller texten "Varukorgen är tom".
*/
...
function showCheckout() {
    if (document.getElementById("checkout")) {
        ...
        if (basketItems.length > 0) {
            ...
            // Tomt i listan
            checkoutEl.innerHTML = "<tr class='cart-empty'><td colspan='5'>Varukorgen är tom</td></tr>";
        }
    }
}
